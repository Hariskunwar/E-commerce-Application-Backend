...
const { createProduct, getAllProduct, getSingleProduct, updateProduct, updateProductImage, deleteProductImage, deleteProduct, ratings } = require("../controllers/productController");
...
router.route("/rating").patch(protect,ratings);                 
